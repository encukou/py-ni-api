...
typedef struct PyLongRef {intptr_t bits;} PyLongRef;
...
typedef struct PySequenceRef {intptr_t bits;} PySequenceRef;
...
typedef struct PyTupleRef {intptr_t bits;} PyTupleRef;
...
typedef struct PyDictRef {intptr_t bits;} PyDictRef;
...
typedef struct PyListRef {intptr_t bits;} PyListRef;
...
typedef struct PyStrRef {intptr_t bits;} PyStrRef;
PyStrRef PyNI_Str_FromUtfString(PyContext ctx, const Utf8String data, uintptr_t length);
...
typedef struct PyClassRef {intptr_t bits;} PyClassRef;
...
typedef struct PyBytesRef {intptr_t bits;} PyBytesRef;
...
typedef struct PyStrBuilderRef {intptr_t bits;} PyStrBuilderRef;
...
int PyNI_StrBuilder_AppendUtf8String(PyContext ctx, PyRef Self, const Utf8String s);
...
typedef struct PyTupleBuilderRef {intptr_t bits;} PyTupleBuilderRef;
...
PyRef PyNI_Object_GetItem_s(PyContext ctx, PyRef obj, const Utf8String key);
...
int PyNI_Object_SetItem_s(PyContext ctx, PyRef obj, const Utf8String key, PyRef value);
...
PyRef PyNI_Object_GetAttr_s(PyContext ctx, PyRef obj, const Utf8String attr);

int PyNI_Object_HasAttr(PyContext ctx, PyRef obj, PyRef attr);

int PyNI_Object_HasAttr_s(PyContext ctx, PyRef obj, const Utf8String attr);

int PyNI_Object_SetAttr(PyContext ctx, PyRef obj, PyRef attr, PyRef value);

int PyNI_Object_SetAttr_s(PyContext ctx, PyRef obj, const Utf8String attr, PyRef value);
...
typedef struct PyExceptionRef {intptr_t bits;} PyExceptionRef;
PyExceptionRef PyNI_Exception_New(PyContext ctx, PyClassRef cls, const Utf8String message);
...
PyRef PyNI_Call_Method(PyContext ctx, const Utf8String name, PyRef args[], intptr_t nargsf, PyTupleRef kwnames);
...
typedef struct PyCodeRef {intptr_t bits;} PyCodeRef;
...
typedef struct PyFrameStackRef {intptr_t bits;} PyFrameStackRef;
...
PyCodeRef PyNI_Eval_Compile_s(PyContext ctx, const Utf8String src, const Utf8String filename, PySourceKindRef kind);
